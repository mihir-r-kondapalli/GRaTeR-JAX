...
class Parameter_Index:
    ...
    misc_params = {'distance': 50., 'pxInArcsec': 0.01414, 'nx': 140, 'ny': 140, 'halfNbSlices': 25}  # Don't change this
...
def objective_ll(params_fit, fit_keys, disk_params, spf_params, psf_params, misc_params,
    ...
    model_image = jax_model(
        DiskModel, DistrModel, FuncModel, PSFModel,
        pack_pars(temp_disk_params, Parameter_Index.disk_params) if isinstance(disk_params, dict) else disk_params,
