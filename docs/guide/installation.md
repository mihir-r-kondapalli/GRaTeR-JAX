...
GRaTer-JAX is compatible with Python XXXXXXXX and any GPU processor supported by JAX (see [the JAX install docs](https://docs.jax.dev/en/latest/installation.html) for a list).
